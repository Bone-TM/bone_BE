...
us3 = User.create(name: 'jamark', email: 'jamark@beve.com', bio: 'dogs r kewl', location: 'denver', password_digest: 'sinoeingmeixnfrx88')
pe3 = Pet.create(name: 'dog', sex: 'male', bio: 'woof', breed: 'cocker-spaniel', weight: 19, age: 5, user_id: us3.id)
us4 = User.create(name: 'dave', email: 'dave@beve.com', bio: 'dogs r kewl', location: 'denver', password_digest: 'sinoeingmeixnfrx88')
pe4 = Pet.create(name: 'cave', sex: 'male', bio: 'woof', breed: 'cocker-spaniel', weight: 19, age: 5, user_id: us4.id)
us5 = User.create(name: 'hat', email: 'hat@beve.com', bio: 'dogs r kewl', location: 'denver', password_digest: 'sinoeingmeixnfrx88')
